...
const user = {
  ...
  lastName: "de Bruijn",
  age: 27,
  dateOfBirth: new Date('November 24, 1993'),
};
...
console.log(`Hoi! Ik ben ${user.firstName}, ik ben ${user.age} jaar oud.`);
...
const productInfo = `${product.productName} is gemaakt van ${product.material[0]} en ${product.material[1]}`;
